...
#** test from toolbar-1.mojo, line 1

my $expected_toolbar_1_1 = qq{
...
$test->get_ok('/toolbar_1_1')->status_is(200)->trimmed_content_is($expected_toolbar_1_1, 'Matched trimmed content in toolbar-1.mojo, line 1');
