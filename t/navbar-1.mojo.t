...
#** test from navbar-1.mojo, line 21
...
$test->get_ok('/navbar_1_2')->status_is(200)->trimmed_content_is($expected_navbar_1_2, 'Matched trimmed content in navbar-1.mojo, line 21');


#** test from navbar-1.mojo, line 69
...
$test->get_ok('/navbar_1_3')->status_is(200)->trimmed_content_is($expected_navbar_1_3, 'Matched trimmed content in navbar-1.mojo, line 69');


#** test from navbar-1.mojo, line 118
...
$test->get_ok('/navbar_1_4')->status_is(200)->trimmed_content_is($expected_navbar_1_4, 'Matched trimmed content in navbar-1.mojo, line 118');
